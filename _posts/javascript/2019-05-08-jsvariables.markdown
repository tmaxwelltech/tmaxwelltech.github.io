...
categories: JavaScript Logging Variables Two
permalink: /jslesson2
---
...
The quote above is taken from the [Great Courses](https://www.thegreatcourses.com/) course on CS. I am a huge fan of The Teaching Company, aka The Great Courses. The courses are not free, but they are money very well spent! So this is how you declare a variable in JavaScript:
...
This step is only if you do not have a javascript directory. See [lesson one](/jslesson1). If you did lesson one, you only need to type:

```bash
$ cd javascript            //makes javascript the new working directory
$ touch variable.js  //creates a new file variable.js
...
```javascript
const x = "the data";
// English translation: 'The constant variable x is assigned the string, 'the data'.'
```
